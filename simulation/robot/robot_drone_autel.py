...
from simulation.robot.cfg import CfgDroneAutel

from simulation.robot.robot import Robot
from simulation.robot.body.body_drone_autel import BodyDroneAutel
...
class RobotDroneAutel(Robot):
    ...
    def setup_lidar_and_ros(self, setup_ros_fn):
        """Setup LiDAR sensor and ROS after creation"""
        from simulation.sensor.lidar import LidarOmni
        from simulation.sensor.lidar import CfgLidar

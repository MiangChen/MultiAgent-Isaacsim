"""
Robot ROS Manager - Manages basic ROS infrastructure for a robot

This class encapsulates basic ROS-related functionality for the robot,
achieving complete decoupling between simulation layer and ROS layer.

Note:
    Navigation nodes (planner, trajectory, MPC) have been moved to
    SkillROSInterface in the Application Layer.
"""
...
class RobotRosManager:
    ...
    def _init_ros_nodes(self):
        ...
        # Main robot node (basic communication only)
    ...
    def stop(self):
        ...
        if self.ros_thread and self.ros_thread.is_alive():
            ...
            if self.ros_thread.is_alive():
                logger.warning(
                    f"ROS thread did not stop gracefully for {self.namespace}"
                )

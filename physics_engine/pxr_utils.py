...
def create_transform_matrix(translation=(0, 0, 0), rotation=(0, 0, 0, 1), scale=(1, 1, 1)):
    """
...
def create_physics_material(stage, path, static_friction=0.5, dynamic_friction=0.5, restitution=0.0):
    """

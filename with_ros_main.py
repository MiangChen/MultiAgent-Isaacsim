...
parser.add_argument("--config", type=str, default="/home/ubuntu/multiagent-isaacsim/src/multiagent_isaacsim/multiagent_isaacsim/files/sim_cfg.yaml", help="Path to the configuration YAML file.")
...
def main():
    ...
    # 创建 Env（保持你原始逻辑）
    with open('/home/ubuntu/multiagent-isaacsim/src/multiagent_isaacsim/multiagent_isaacsim/files/env_cfg.yaml', 'r') as f:
